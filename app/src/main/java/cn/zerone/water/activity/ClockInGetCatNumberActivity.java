...
public class ClockInGetCatNumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clock_in_car_number);

        ImageView carNumberBack = findViewById(R.id.carNumberBack);
        carNumberBack.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        carList = findViewById(R.id.carNumberList);
