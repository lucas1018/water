...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int mode = JCameraView.BUTTON_STATE_BOTH;
        try{
            mode = getIntent().getExtras().getInt("mode", JCameraView.BUTTON_STATE_BOTH);
        }catch (Exception e){
            e.printStackTrace();
        }
        jCameraView.setFeatures(mode);
        jCameraView.setTip("JCameraView Tip");
        jCameraView.setMediaQuality(JCameraView.MEDIA_QUALITY_SORRY);
