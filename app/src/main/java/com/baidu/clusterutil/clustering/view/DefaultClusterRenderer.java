...
package com.baidu.clusterutil.clustering.view;
...
import com.baidu.clusterutil.MarkerManager;
...
import com.baidu.clusterutil.projection.Point;
import com.baidu.clusterutil.projection.SphericalMercatorProjection;
import com.baidu.clusterutil.ui.IconGenerator;
...
import static com.baidu.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.baidu.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.baidu.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        com.baidu.clusterutil.ui.SquareTextView squareTextView =
                new com.baidu.clusterutil.ui.SquareTextView(context);
